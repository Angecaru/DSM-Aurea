...
{
public partial class ProductoCarritoCP : GenericBasicCP
{
public ProductoCarritoCP(GenericSessionCP currentSession)
        : base (currentSession)
{
}

public ProductoCarritoCP(GenericSessionCP currentSession, GenericUnitOfWorkUtils unitUtils)
