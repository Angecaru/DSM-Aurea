...
{
public partial class DetallePedidoCP : GenericBasicCP
{
public DetallePedidoCP(GenericSessionCP currentSession)
        : base (currentSession)
{
}

public DetallePedidoCP(GenericSessionCP currentSession, GenericUnitOfWorkUtils unitUtils)
